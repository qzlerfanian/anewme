...
class MT5Broker(BrokerBase):
    ...
    def _fetch_candles(self, symbol: str, timeframe_key: str, count: int) -> list[dict]:
        ...
        # position=0 کندل درحال‌تشکیل است. تمام مصرف‌کنندگان این متد
        # (چارت، Trigger و Last Closed Candle) فقط کندل بسته می‌خواهند.
    ...
    def get_market_snapshot(self, symbol: str) -> MarketSnapshot:
        ...
        return MarketSnapshot(
            ...
            market_time_utc=datetime.fromtimestamp(tick.time, tz=timezone.utc),
